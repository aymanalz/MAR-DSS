...
from mar_dss.pfdf._utils import aslist, astuple, real
from mar_dss.pfdf.errors import DimensionError, EmptyArrayError, ShapeError

if typing.TYPE_CHECKING:
    from typing import Any, Optional

    from mar_dss.pfdf.typing.core import (
        MatrixArray,
        RealArray,
        ScalarArray,
        VectorArray,
