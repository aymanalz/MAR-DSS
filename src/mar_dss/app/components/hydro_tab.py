                        ...
                        dbc.Row(
                            [
                                                ...
                                                dbc.Col(
                                                    [
                                                        ...
                                                        dbc.Select(
                                                            ...
                                                            options=[
                                                                {
                                                                    "label": "Aquifer (High Permeability)",
                                                                    "value": "aquifer",
                                                                },
                                                                {
                                                                    "label": "Aquitard (Low Permeability)",
                                                                    "value": "aquitard",
                                                                },
                                                                {
                                                                    "label": "Confining Layer",
                                                                    "value": "confining",
                                                                },
                                                                {
                                                                    "label": "Bedrock",
                                ...
                                dbc.Col(
                                    [
                                        html.H6(
                                            "Vertical Profile (Top to Bottom)",
                                            className="fw-bold mb-3",
                                        ),
                                        html.Div(
