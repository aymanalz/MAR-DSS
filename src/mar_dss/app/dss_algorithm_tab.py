...
def create_dss_algorithm_content():
    ...
    return html.Div([
        ...
        html.P("Advanced decision support algorithms for MAR project evaluation."),
        ...
        dbc.Row([
            dbc.Col([
                ...
                dbc.Select(
                    options=[
                        {"label": "Multi-Criteria Decision Analysis", "value": "mcda"},
        ...
        html.H5("Results:"),
        html.P("The DSS algorithm has analyzed your MAR project parameters and generated comprehensive recommendations based on multi-criteria decision analysis.")
    ])
