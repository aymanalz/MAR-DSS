...
def create_quality_content():
    ...
    categories = ['Water Supply Security', 'Environmental Impact', 'Economic Viability', 'Technical Feasibility', 'Regulatory Compliance']
    ...
    return html.Div([
        ...
        html.P("Based on the analysis, this MAR project shows strong potential with high scores in water supply security, economic viability, and regulatory compliance. Consider addressing environmental impact concerns through additional mitigation measures.")
    ])
...
def create_scenarios_content():
    ...
    scenarios = ['Baseline', 'Optimistic', 'Pessimistic', 'Climate Change', 'High Demand']
    ...
    return html.Div([
        ...
        html.P("Compare different MAR project scenarios and their outcomes."),
        dcc.Graph(figure=fig),
        html.Hr(),
        ...
        html.Div([
            dbc.Row([
                dbc.Col([
                    html.H6("Baseline Scenario", className="fw-bold"),
                    html.P("Standard conditions with moderate growth"),
                    html.Ul([
                ...
                dbc.Col([
                    html.H6("Optimistic Scenario", className="fw-bold"),
                    html.P("Best-case conditions with high efficiency"),
                    html.Ul([
        ...
        html.Hr(),
        html.H5("Recommendations:", className="mt-3"),
        html.P("The Optimistic scenario shows the highest potential across all metrics. Consider implementing efficiency measures to achieve optimistic outcomes while preparing contingency plans for pessimistic conditions.")
    ])
...
def create_ai_decision_content():
    ...
    decision_factors = ['Water Availability', 'Economic Viability', 'Environmental Impact', 'Technical Feasibility', 'Regulatory Compliance', 'Social Acceptance']
    ...
    return html.Div([
        ...
        html.P("Artificial Intelligence powered decision recommendations and analysis."),
        dcc.Graph(figure=fig),
        html.Hr(),
        html.H5("AI Recommendation:", className="mt-3"),
        dbc.Alert([
            html.H6("RECOMMENDED: Proceed with MAR Project", className="alert-heading"),
            html.P("Based on comprehensive AI analysis, this project shows strong potential with an overall recommendation score of 85.6%"),
            html.Hr(),
            html.P("Confidence Level: 89%", className="mb-0")
        ], color="success"),
        html.H5("Key AI Insights:", className="mt-3"),
        html.Ul([
            html.Li("Water Availability: Excellent (92% score, 95% confidence)"),
            html.Li("Economic Viability: Strong (88% score, 92% confidence)"),
            html.Li("Regulatory Compliance: High (90% score, 94% confidence)"),
            html.Li("Environmental Impact: Moderate (76% score, 78% confidence)"),
            html.Li("Technical Feasibility: Good (85% score, 88% confidence)"),
            html.Li("Social Acceptance: Fair (82% score, 85% confidence)")
        ]),
        html.Hr(),
        html.H5("AI Recommendations:", className="mt-3"),
        html.P("The AI system recommends proceeding with the MAR project while implementing additional environmental mitigation measures to address the moderate environmental impact score. Focus on community engagement to improve social acceptance.")
    ])
