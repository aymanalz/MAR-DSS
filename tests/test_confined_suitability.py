...
if __name__ == "__main__":
    ...
    inputs["stratigraphy_table"]= [[120, None, None], # overburden layer
                                  [5, 1e-6, 1e-7], # top confining layer
                                  [200, 30, 1e-4], # aquifer layer
                                  [5, 1e-6, 1e-7]] # bottom confining layer
    inputs["monthly_gw_depth"] = 12*[150]
